...
echo "**                           **"
echo "** Creates the basic network **"
...
neutron subnet-create --name NetA_Sub1 --no-gateway --disable-dhcp NetA 172.0.0.0/25 > $SUBNET_PATH
neutron subnet-create --name NetB_Sub1 --no-gateway --disable-dhcp NetB 172.0.0.128/25 >> $SUBNET_PATH
neutron subnet-create --name NetC_Sub1 --no-gateway --disable-dhcp NetC 172.0.1.0/25 >> $SUBNET_PATH
neutron subnet-create --name NetD_Sub1 --no-gateway --disable-dhcp NetD 172.0.1.128/25 >> $SUBNET_PATH
echo "done."
